...
\pagestyle{fancy}
\lhead{CE 4333 Practical Computational Hydraulics }
\rhead{SUMMER 2017}
\lfoot{}
\cfoot{}
...
\begingroup
\begin{center}
{\textbf{{CE 4333 Practical Computational Hydraulics using \textbf{R}\footnote{The preferred programming tool of pirates, everywhere! Rrrrrrr \dots}} \\ {}}}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./2-Algorithms/algorithms}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./3-Differentation/differentation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./4-TankDrain/tankdrain}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./5-LinearSystems/LinearSystems}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./6-NonLinearSystems/NonLinearSystems}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./7-NewtonRaphson/NewtonRaphson}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./8-PipeNetworkHydraulics/PipeNetworkHydraulics}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./9-PipelineNetworkAnalysis/PipelineNetworks}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./10-PumpsAndValves/PumpsAndValves}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./11-PipelineTransients/PipelineTransients}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./12-OpenChannelFlow/OpenChannelFlow}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./13-SteadyWSP/SteadyWSP}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./14-UnsteadyOpenChannel/UnsteadyOpenChannel}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./15-MOCBoundaries/MOCBoundaries}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./16-PorousMediumFlow/PorousMediumFlow}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./17-SteadyGroundwaterFlow/SteadyGroundwaterFlow}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./18-UnsteadyGroundwaterFlow/UnsteadyGroundwaterFlow}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./19-FlowNets/FlowNets}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./20-TheoryMassTransport/TheoryMassTransport}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./21-AnalSolMassTransport/AnalSolMassTransport}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{./22-NumSolMassTransport/NumSolMassTransport}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
